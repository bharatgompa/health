...
function mailUser($email,$hash)
{
    ...
    $header="From:ritsh56@gmail.com"."\r\n".
                "CC: apurva.sharma.756@gmail.com";
    $message="Click the link below to activate your account\n\n http://localhost/healthcare/hospital/confirmMail.php?email=$email&hash=$hash";
...
<script>
    ...
    function showPosition(position) {
        ...
        google.maps.event.addListener(mark, 'click', function() {
            ...
            '<div id="bodyContent">'+
            '<a href="http://localhost/healthcare/hospital/signup.php?hid=' + place.place_id + '">'+
